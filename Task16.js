...
console.log("Dear ".concat(guest_list[3], " You are cordially invited to a dinner party at my place"));
console.log("Dear ".concat(guest_list[4], " You are cordially invited to a dinner party at my place"));
console.log("Dear ".concat(guest_list[5], " You are cordially invited to a dinner party at my place"));
